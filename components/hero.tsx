        ...
        <div className="max-w-3xl mx-auto text-center">
          ...
          <ScrollAnimation variant="fadeIn" delay={0.6} duration={0.8}>
            <div className="flex flex-col sm:flex-row justify-center gap-4 mb-12">
              ...
              <Link
                href="/games"
                className="bg-transparent border-2 border-amber-500 text-amber-400 hover:bg-amber-500/10 font-bold px-8 py-4 rounded-md transition-all duration-300 text-lg transform hover:scale-105 active:scale-95"
              >
                ゲームを見る
              </Link>
            </div>
          ...
          <ScrollAnimation variant="fadeInUp" delay={0.9} duration={0.8}>
            <div className="flex justify-center space-x-8">
              <div className="text-center">
                ...
                <p className="text-gray-400">ゲーム</p>
              </div>
              <div className="text-center">
                <p className="text-3xl md:text-4xl font-bold text-amber-400">
                  <Typing text="24/7" speed={100} />
                </p>
                <p className="text-gray-400">サポート</p>
              </div>
              <div className="text-center">
                <p className="text-3xl md:text-4xl font-bold text-amber-400">
                  <CountUp end={98} suffix="%" />
                </p>
                <p className="text-gray-400">ペイアウト率</p>
              </div>
            </div>
          </ScrollAnimation>
        </div>
